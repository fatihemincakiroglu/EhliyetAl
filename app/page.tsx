    ...
    <div className="min-h-screen bg-paper">
      <main className="max-w-3xl mx-auto px-5 sm:px-6 py-12 sm:py-20">
        <div className="flex items-center gap-2 mb-5">
          <span
            className="font-display font-bold text-sm sm:text-base text-ink bg-sun border-2 border-ink rounded-full px-4 py-1.5 shadow-[3px_3px_0_var(--shadow-hard-color)] -rotate-2 inline-block"
          >
            EhliyetAl
          </span>
