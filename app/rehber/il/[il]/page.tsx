      ...
      <main className="max-w-2xl mx-auto px-5 sm:px-6 py-8 sm:py-14">
        ...
        <div className="flex flex-col sm:flex-row gap-3 mb-10">
          ...
          <Link
            ...
            className="font-display text-sm tracking-wide uppercase rounded-full border border-line text-ink px-6 py-3 text-center hover:bg-gold-wash hover:border-gold-soft transition-colors"
          >
