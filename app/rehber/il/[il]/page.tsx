    ...
    <div className="min-h-screen bg-paper">
      ...
      <main className="max-w-2xl mx-auto px-5 sm:px-6 py-8 sm:py-14">
        ...
        <div className="flex flex-col sm:flex-row gap-3 mb-10">
          <Link
            href="/sinav"
            className="font-display text-sm tracking-wide uppercase rounded-full gold-gradient text-ink px-6 py-3 text-center hover:bg-gold-soft transition-colors"
          >
            Deneme Sınavı Çöz
          </Link>
          <Link
            href="/rehber/ehliyet-sinavi-basvurusu-nasil-yapilir"
            className="font-display text-sm tracking-wide uppercase btn-hard-outline rounded-full border-2 border-ink text-ink bg-surface px-6 py-3 text-center hover:bg-gold-wash hover:border-gold-soft transition-colors"
          >
