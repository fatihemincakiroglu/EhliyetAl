    ...
    <div className="min-h-screen bg-paper flex items-center justify-center">
      <main className="max-w-md mx-auto px-6 py-14 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          ...
          <Link
            href="/"
            className="flex items-center justify-center gap-2 font-display text-sm tracking-wide uppercase btn-hard-outline rounded-full border-2 border-ink text-ink bg-surface px-6 py-3 hover:bg-gold-wash hover:border-gold-soft transition-colors"
          >
            <Home size={16} />
            Ana Sayfaya Dön
          </Link>
