  ...
  return (
    <div className="flex flex-col sm:flex-row gap-3 mb-10">
      ...
      {dueCount > 0 && (
        <Link
          href="/tekrar"
          className="flex-1 flex items-center justify-center gap-2 rounded-full gold-gradient text-white px-5 py-3 text-sm font-display tracking-wide uppercase hover:bg-gold-soft transition-colors"
        >
          <RefreshCcw size={16} />
