  ...
  return (
    <div className="min-h-screen bg-paper">
      <main className="max-w-2xl mx-auto px-5 sm:px-6 py-8 sm:py-14">
        ...
        <div className="premium-card bg-surface border border-line rounded-2xl p-6 sm:p-8">
          ...
          <button
            ...
            className="btn-hard w-full sm:w-auto font-display text-sm tracking-wide uppercase rounded-full gold-gradient text-white px-8 py-3.5 hover:bg-gold-soft transition-colors"
          >
            Sınavı Başlat
          </button>
        </div>
